...
extension ReplyStatePatterns on ReplyState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ReplyState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<CommentModel> replies, bool isLoading, String? error,
    ...
    switch (_that) {
      case _ReplyState() when $default != null:
        return $default(_that.replies, _that.isLoading, _that.error,
            _that.hasMore, _that.lastDocument);
      case _:
        return orElse();
    }
  }
