...
extension CommentStatePatterns on CommentState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<CommentModel> comments, bool isLoading, bool hasMore,
            String sortBy, DocumentSnapshot? lastDocument, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CommentState() when $default != null:
        return $default(_that.comments, _that.isLoading, _that.hasMore,
            _that.sortBy, _that.lastDocument, _that.error);
      case _:
        return orElse();
    }
  }
...
extension CommentThreadStatePatterns on CommentThreadState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CommentThreadState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CommentThreadState() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _CommentThreadState() when $default != null:
        return $default(_that.parentComment, _that.replies, _that.isLoading,
            _that.hasMore, _that.lastDocument, _that.error);
      case _:
        return orElse();
    }
  }
...
/// Adds pattern-matching-related methods to [ExpandedCommentsState].
extension ExpandedCommentsStatePatterns on ExpandedCommentsState {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExpandedCommentsState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ExpandedCommentsState() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Set<String> expandedCommentIds)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ExpandedCommentsState() when $default != null:
        return $default(_that.expandedCommentIds);
      case _:
        return orElse();
    }
  }
...
/// Adds pattern-matching-related methods to [CommentInteractionState].
extension CommentInteractionStatePatterns on CommentInteractionState {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CommentInteractionState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CommentInteractionState() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLiked, bool isDisliked, int likeCount,
            int dislikeCount, bool isLoading)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CommentInteractionState() when $default != null:
        return $default(_that.isLiked, _that.isDisliked, _that.likeCount,
            _that.dislikeCount, _that.isLoading);
      case _:
        return orElse();
    }
  }
