...
/// Adds pattern-matching-related methods to [EditAltProfileState].
extension EditAltProfileStatePatterns on EditAltProfileState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EditAltProfileState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _EditAltProfileState() when $default != null:
