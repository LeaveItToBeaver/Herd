...
class PublicProfileEditScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PublicProfileEditScreen> createState() => _PublicProfileEditScreenState();
}

class _PublicProfileEditScreenState extends ConsumerState<PublicProfileEditScreen> {
  ...
  Future<void> _pickProfileImage() async {
    ...
    if (image != null) {
      ...
      ref.read(editPublicProfileProvider(widget.user).notifier).profileImageChanged(_profileImage);
    }
  }
  ...
  Future<void> _pickCoverImage() async {
    ...
    if (image != null) {
      ...
      ref.read(editPublicProfileProvider(widget.user).notifier).coverImageChanged(_coverImage);
    }
  }
