...
import 'features/social/chat_messaging/chat_provider_test.dart' as chat_provider_tests;
import 'features/social/chat_messaging/message_repository_test.dart' as message_repo_tests;
...
import 'features/customization_tests/customization_model_test.dart' as customization_tests;

void main() {
  group('All Tests', () {
    group('Chat Tests', () {
      chat_provider_tests.main();
