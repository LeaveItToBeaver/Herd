...
void main() {
  group('MessageRepository', () {
    ...
    group('sendMessage', () {
      test('should send plaintext message when encryption not available', () async {
    ...
    group('searchMessages', () {
      test('should find messages containing query text', () async {
        ...
        expect(results.every((msg) => 
          msg.content?.toLowerCase().contains(query) ?? false), true);
      });
    });
...
class MockChatCryptoService extends Mock implements ChatCryptoService {}
