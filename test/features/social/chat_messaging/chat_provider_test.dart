  ...
  group('OptimisticMessagesNotifier', () {
    ...
    test('should count pending messages', () {
      final pendingMessage =
          _createTestMessage(id: 'pending', status: MessageStatus.sending);
      final deliveredMessage =
          _createTestMessage(id: 'delivered', status: MessageStatus.delivered);
    ...
    test('should count failed messages', () {
      final failedMessage =
          _createTestMessage(id: 'failed', status: MessageStatus.failed);
      final successMessage =
          _createTestMessage(id: 'success', status: MessageStatus.delivered);
